...
var ienak = document.getElementByClassName("total income").innerHTML;
var izdev = document.getElementsByClassName("total_expenses").innerHTML;
var atlik = document.getElementById("budget_value").innerHTML;
function function_1 (ienak,izdev){
    return ienak-izdev;
}
